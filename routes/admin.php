...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::post('vendor/search', 'ItemController@search_vendor')->name('vendor-search');
        ...
        Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => ['module:order']], function () {
            ...
            Route::post('store/search', 'OrderController@store_order_search')->name('vendor-search');
            Route::get('store/export/{type}/{store_id}', 'OrderController@store_order_export')->name('vendor-export');
            //order update
