                ...
                <div class="search--button-wrapper">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item" href="{{route('admin.vendor.export', ['type'=>'excel',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                    alt="Image Description">
                                {{ translate('messages.excel') }}
                            </a>
                            <a id="export-csv" class="dropdown-item" href="{{route('admin.vendor.export', ['type'=>'csv',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                                    src="{{ asset('public/assets/admin') }}/svg/components/placeholder-csv-format.svg"
                                    alt="Image Description">
                                .{{ translate('messages.csv') }}
                            </a>
                            {{-- <a id="export-pdf" class="dropdown-item" href="{{route('admin.vendor.export', ['type'=>'excel',request()->getQueryString()])}}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="border-0">{{translate('Created On')}}</th>
                    ...
                    @foreach($stores as $key=>$store)
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="{{route('admin.vendor.view', $store->id)}}" class="table-rest-info" alt="view store">
                            ...
                            <td>
                                <span class="d-block font-size-sm text-body">
                                    {{date('d F Y', strtotime($store->created_at))}}
                                </span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    ...
                                    href="{{route('admin.vendor.edit',[$store['id']])}}" title="{{translate('messages.edit')}} {{translate('messages.store')}}"><i class="tio-edit"></i>
                                    </a>
