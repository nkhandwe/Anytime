                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                               ...
                                               value="{{auth('admin')->user()->f_name}}" readonly>
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                               ...
                                               value="{{auth('admin')->user()->l_name}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" readonly class="js-masked-input form-control" name="phone" id="phoneLabel"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           ...
                                           placeholder="{{translate('messages.enter_new_email_address')}}" aria-label="{{translate('messages.enter_new_email_address')}}" readonly>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="mb-3">
                                        <input type="password" class="form-control" name="confirm_password"
                                               ...
                                               aria-label="{{translate('messages.confirm_new_password')}}" required readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- End Form Group -->
